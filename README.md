...
The 'databricks_asset_bundles' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_asset_bundles_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_asset_bundles.job.yml). The schedule
